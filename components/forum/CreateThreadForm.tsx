  ...
  async function handleSubmit(event: React.FormEvent) {
    ...
    try {
      const newThread = await forumStorage.saveThread({
        ...
        authorRole: member?.role === 'teacher' ? 'Teacher' : member?.role === 'admin' ? 'Admin' : 'Koterie member', category: categoryId,
        pinned: false, tags,
      })
