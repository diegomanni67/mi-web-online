        ...
        <div className="w-full max-w-lg">
          ...
          <div className="rounded-3xl glass border border-border/50 p-8 shadow-[0_8px_40px_oklch(0_0_0/0.08)]">
            ...
            <button
              ...
              disabled={isLoading}
              className={cn(
                "w-full mb-4 flex items-center justify-center gap-3 rounded-2xl border border-border/50 bg-background px-4 py-3 text-sm font-medium transition-all duration-300",
                "hover:border-[oklch(0.72_0.19_220/0.5)] hover:bg-[oklch(0.72_0.19_220/0.05)] hover:shadow-[0_4px_20px_oklch(0.72_0.19_220/0.1)]",
              ...
              {isLoading ? (
                ...
                <>
                  <svg className="size-4" viewBox="0 0 24 24">
                    ...
                    <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23z"/>
